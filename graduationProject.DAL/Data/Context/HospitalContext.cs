    ...
    public class HospitalContext : IdentityDbContext<Patient>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            var Admin = new List<Admin>
                    {
                        new Admin { Name = "Admin 1", Phone = 1234567890, UserName = "admin1" },
                        new Admin { Name = "Admin 2", Phone = 9876543210, UserName = "admin2" },
                        new Admin { Name = "Admin 3", Phone = 5555555555, UserName = "admin3" },
                        new Admin { Name = "Admin 4", Phone = 9999999999, UserName = "admin4" },
                        new Admin { Name = "Admin 5", Phone = 1111111111, UserName = "admin5" }
                    };
            #endregion
            #region  Doctor
            var Doctor = new List<Doctor>
                    {
                        new Doctor
                        {
                            ...
                            AssistantPhoneNumber = 9876543210,
                        ...
                        new Doctor
                        {
                            ...
                            AssistantPhoneNumber = 7777777777,
                        ...
                        new Doctor
                        {
                            ...
                            AssistantPhoneNumber = 8888888888,
                        ...
                        new Doctor
                        {
                            ...
                            AssistantPhoneNumber = 6666666666,
                        ...
                        new Doctor
                        {
                            ...
                            AssistantPhoneNumber = 4444444444,
            ...
            var PatientVisitsWithDoctor = new List<PatientVisitsWithDoctor>
                {
                    ...
                    {
                        Patient = context.Patients.FirstOrDefault(p => p.UserName == "patient1"),
